...
export const PARTNER_GROUP_MANAGER_PERMISSION_TARGETS: PermissionTarget[] = [
  ...
  PermissionTarget.OrderAll,
  PermissionTarget.RecallRequestAll,
  PermissionTarget.ReturnApprovalAll,
];
...
export const FULFILLMENT_GROUP_MANAGER_PERMISSION_TARGETS: PermissionTarget[] = [
  PermissionTarget.RoleAll,
  PermissionTarget.UserAll,
